...
class SmartClass_LMS_Provider {
	...
	function lmsSetSchoolInfo($scId)
	{
        ...
        $this->restformat = ($this->restformat == 'json') ? '&moodlewsrestformat=' . $this->restformat : '';
	}
    ...
    */
    ...
    /**
     * [section] => string Varsayılan değer "" //Settings section name.
     * 
     */
