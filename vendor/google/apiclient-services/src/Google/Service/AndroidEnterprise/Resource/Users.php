...
class Google_Service_AndroidEnterprise_Resource_Users extends Google_Service_Resource
{
   ...
   *
   * The User resource passed in the body of the request should include an
   ...
   * the id is already returned in the result of the User.insert call.
   * (users.listUsers)
   *
   * @param string $enterpriseId The ID of the enterprise.
   ...
   * new details in the User resource in the request body. Only the displayName
