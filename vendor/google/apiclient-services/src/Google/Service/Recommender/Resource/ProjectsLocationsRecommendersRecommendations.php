...
class Google_Service_Recommender_Resource_ProjectsLocationsRecommendersRecommendations extends Google_Service_Resource
{
  ...
  /**
   * Marks the Recommendation State as Claimed. User can use this method to
  ...
  /**
   * Marks the Recommendation State as Failed. User can use this method to
  ...
  /**
   * Marks the Recommendation State as Succeeded. User can use this method to
   * indicate to the Recommender API that they have applied the recommendation
